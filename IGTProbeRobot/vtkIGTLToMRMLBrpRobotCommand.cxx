  ...
  if (mrmlNode && event == vtkCommand::ModifiedEvent)
    ...
    if (strcmp(command.c_str(), "MOVE_TO") == 0)
      ...
      if (!commandNode->GetScene())
        ...
        //= vtkMRMLRobotNode::SafeDownCast(mrmlNode);
        //vtkRobotProbeNavTargetingStep* RobotNode2 
        //= vtkRobotProbeNavTargetingStep::SafeDownCast(mrmlNode);
      ...
      //vtkMRMLNode* node = commandNode->GetScene()->GetNodeByID(RobotNode->GetMarkersPositionTransformId());
      //vtkMRMLNode* node = commandNode->GetScene()->GetNodeByID(RobotNode2->GetRobotProbeNavManager()->GetRobotNode()->GetMarkersPositionTransformId());
      ...
      if (transformNode)
        ...
        *igtlMsg = (void*)this->OutMoveToMsg->GetPackPointer();
        ...
        // 1/20/2012 ayamada
        std::cerr << "Sent the target position!!" << std::endl;
