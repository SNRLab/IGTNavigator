...
=========================================================================auto=*/
// .NAME vtkMRMLBrpRobotCommandNode - MRML node to represent BRP RobotProbe Robot
// .SECTION Description
//
...
class VTK_RobotProbeNAV_EXPORT vtkMRMLBrpRobotCommandNode : public vtkMRMLNode
{
 public:
