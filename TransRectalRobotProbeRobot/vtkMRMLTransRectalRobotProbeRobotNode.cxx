...
Program:   3D Slicer
Module:    $RCSfile: vtkMRMLTransRectalRobotProbeRobotNode.cxx,v $
...
//------------------------------------------------------------------------------
vtkMRMLTransRectalRobotProbeRobotNode* vtkMRMLTransRectalRobotProbeRobotNode::New()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkMRMLTransRectalRobotProbeRobotNode");
  if(ret)
    {
      return (vtkMRMLTransRectalRobotProbeRobotNode*)ret;
    }
  // If the factory was unable to create the object, then create it here.
  return new vtkMRMLTransRectalRobotProbeRobotNode;
}

//----------------------------------------------------------------------------
vtkMRMLTransRectalRobotProbeRobotNode* vtkMRMLTransRectalRobotProbeRobotNode::CreateNodeInstance()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkMRMLTransRectalRobotProbeRobotNode");
  if(ret)
...
//----------------------------------------------------------------------------
vtkMRMLTransRectalRobotProbeRobotNode::vtkMRMLTransRectalRobotProbeRobotNode()
{
  // Calibration inputs
...
void vtkMRMLTransRectalRobotProbeRobotNode::RemoveChildNodes()
{
...
//----------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::ReadXMLAttributes(const char** atts)
{
...
//----------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::PrintSelf(ostream& os, vtkIndent indent)
{
...
void vtkMRMLTransRectalRobotProbeRobotNode::Copy(vtkMRMLNode *anode)
{
  Superclass::Copy(anode);
  vtkMRMLTransRectalRobotProbeRobotNode *node = (vtkMRMLTransRectalRobotProbeRobotNode *) anode;
...
//----------------------------------------------------------------------------
int vtkMRMLTransRectalRobotProbeRobotNode::Init(vtkSlicerApplication* app, const char* moduleShareDir)
{ 
  ...
  {
    const char* nodeID = AddModelNode("TransrectalRobotProbeRobotModel", 0.5, 0.5, 1.0);
    this->SetRobotModelNodeRef(nodeID);
  }
  // Workspace model
  if (GetWorkspaceModelNode()==NULL)
  {
    const char* nodeID = AddModelNode("TransrectalRobotProbeWorkspaceModel", 0.2, 0.8, 0.2);
...
//----------------------------------------------------------------------------
const char* vtkMRMLTransRectalRobotProbeRobotNode::AddModelNode(const char* nodeName, double colorR, double colorG, double colorB)
{  
...
//----------------------------------------------------------------------------
vtkMRMLModelNode* vtkMRMLTransRectalRobotProbeRobotNode::GetRobotModelNode()
{
...
//----------------------------------------------------------------------------
vtkMRMLModelNode* vtkMRMLTransRectalRobotProbeRobotNode::GetWorkspaceModelNode()
{
...
//----------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::ProcessMRMLEvents( vtkObject *caller, unsigned long event, void *callData )
{
...
bool vtkMRMLTransRectalRobotProbeRobotNode::GetNeedleDirectionAtTarget(vtkRobotProbeNavTargetDescriptor *targetDesc, NeedleDescriptorStruct *needle, double* needleDirection)
{
  ...
  TRRobotProbeBiopsyTargetingParams targetingParams;
...
//----------------------------------------------------------------------------
std::string vtkMRMLTransRectalRobotProbeRobotNode::GetTargetInfoText(vtkRobotProbeNavTargetDescriptor *targetDesc, NeedleDescriptorStruct *needle)
{
  TRRobotProbeBiopsyTargetingParams targetingParams;  
...
//------------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::RemoveAllCalibrationMarkers()
{
...
//------------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::SetCalibrationInputs(const char *calibVolRef,
...
//------------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::UpdateCalibration()
{
  ...
  TRRobotProbeBiopsyCalibrationFromImageInput in; // struct that stores all inputs required for the calib algo
  ...
  const TRRobotProbeBiopsyCalibrationData calibData=calibrationAlgo->GetCalibrationData();  
...
//------------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::ResetCalibrationData()
{
  bool modified=false;
...
//------------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::UpdateWorkspaceModel()
{
  ...
  vtksys_stl::string modelFileName=this->ModuleShareDirectory+"/TransRectalRobotProbeRobot/Workspace150mm.stl";
...
//------------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::UpdateRobotModel()
{
  vtkMRMLModelNode* modelNode=GetRobotModelNode();
  if (modelNode==NULL)
  {
...
//------------------------------------------------------------------------------
bool vtkMRMLTransRectalRobotProbeRobotNode::ShowRobotAtTarget(vtkRobotProbeNavTargetDescriptor *targetDesc, NeedleDescriptorStruct *needle)
{
...
//------------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::UpdateRobotModelNeedle(vtkRobotProbeNavTargetDescriptor *targetDesc, NeedleDescriptorStruct *needle)
{
  if (targetDesc==NULL)
  {
...
//------------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::UpdateRobotModelProbe()
{
  ...
  vtksys_stl::string modelFileName=this->ModuleShareDirectory+"/TransRectalRobotProbeRobot/Sheath.stl";
  modelReader->SetFileName(modelFileName.c_str());
  modelReader->Update();
...
//------------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::UpdateRobotModelAxes()
{
  this->ModelAxes->Reset();
...
//------------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::UpdateRobotModelMarker(int markerInd, vtkImageData *imagedata, vtkMatrix4x4* ijkToRAS)
{
...
//------------------------------------------------------------------------------
bool vtkMRMLTransRectalRobotProbeRobotNode::GetRobotBaseTransform(vtkMatrix4x4* transform)
{
  if (!this->CalibrationData.CalibrationValid)
  {
...
//------------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::SetModelAxesVisible(bool visible)
{ 
...
//----------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::UpdateReferenceID(const char *oldID, const char *newID)
{
...
//----------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::UpdateReferences()
{
...
//----------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::UpdateScene(vtkMRMLScene *scene)
{
...
//----------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::SetAndObserveCalibrationPointListNodeID(const char *calibrationPointListNodeID)
{
...
//----------------------------------------------------------------------------
vtkMRMLFiducialListNode* vtkMRMLTransRectalRobotProbeRobotNode::GetCalibrationPointListNode()
{
...
//----------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::SetAndObserveCalibrationVolumeNodeID(const char *calibrationVolumeNodeID)
{
...
//----------------------------------------------------------------------------
vtkMRMLScalarVolumeNode* vtkMRMLTransRectalRobotProbeRobotNode::GetCalibrationVolumeNode()
{
...
//----------------------------------------------------------------------------
double vtkMRMLTransRectalRobotProbeRobotNode::GetMarkerSegmentationThreshold(int i)
{
...
//----------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::ApplyTransform(vtkMatrix4x4* transformMatrix)
{ 
...
//----------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::TransformCalibrationData(vtkMatrix4x4* transformMatrix)
{ 
...
//----------------------------------------------------------------------------
void vtkMRMLTransRectalRobotProbeRobotNode::TransformRobotModelMarkers(vtkMatrix4x4* transformMatrix)
{   
  vtkSmartPointer<vtkTransformPolyDataFilter> polyTrans = vtkSmartPointer<vtkTransformPolyDataFilter>::New(); 
