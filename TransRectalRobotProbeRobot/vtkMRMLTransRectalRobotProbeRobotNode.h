/*=auto=========================================================================
  ...
  Program:   3D Slicer
  Module:    $RCSfile: vtkMRMLTransRectalRobotProbeRobotNode.h,v $
...
class VTK_RobotProbeNAV_EXPORT vtkMRMLTransRectalRobotProbeRobotNode : public vtkMRMLRobotNode
{
 public:
  ...
  static vtkMRMLTransRectalRobotProbeRobotNode *New();
  vtkTypeMacro(vtkMRMLTransRectalRobotProbeRobotNode,vtkMRMLRobotNode);
  ...
  virtual vtkMRMLTransRectalRobotProbeRobotNode* CreateNodeInstance();
  ...
  virtual const char* GetNodeTagName()
    {return "TransRectalRobotProbeRobot";};
  ...
  virtual bool GetNeedleDirectionAtTarget(vtkRobotProbeNavTargetDescriptor *targetDesc, NeedleDescriptorStruct *needle, double* needleDirection);
  virtual bool ShowRobotAtTarget(vtkRobotProbeNavTargetDescriptor *targetDesc, NeedleDescriptorStruct *needle);
  //BTX
  ...
  const TRRobotProbeBiopsyCalibrationData& GetCalibrationData() { return this->CalibrationData; }
 ...
 protected:
  ...
  vtkMRMLTransRectalRobotProbeRobotNode();
  virtual ~vtkMRMLTransRectalRobotProbeRobotNode();
  vtkMRMLTransRectalRobotProbeRobotNode(const vtkMRMLTransRectalRobotProbeRobotNode&);
  void operator=(const vtkMRMLTransRectalRobotProbeRobotNode&);  
 ...
 protected:
  ...
  void UpdateRobotModelNeedle(vtkRobotProbeNavTargetDescriptor *targetDesc, NeedleDescriptorStruct *needle);
  ...
  TRRobotProbeBiopsyCalibrationData CalibrationData;
