...
//BTX
struct TRRobotProbeBiopsyCalibrationFromImageInput
{
...
struct TRRobotProbeBiopsyCalibrationData
{
...
struct TRRobotProbeBiopsyTargetingParams
{ 
...
class VTK_RobotProbeNAV_EXPORT vtkTransRectalFiducialCalibrationAlgo :
  public vtkObject
{
public:
  ...
  bool CalibrateFromImage(const TRRobotProbeBiopsyCalibrationFromImageInput &input);  
  //ETX

  static bool FindTargetingParams(vtkRobotProbeNavTargetDescriptor *target, const TRRobotProbeBiopsyCalibrationData &calibrationData, NeedleDescriptorStruct *needle, TRRobotProbeBiopsyTargetingParams *targetingParams);
