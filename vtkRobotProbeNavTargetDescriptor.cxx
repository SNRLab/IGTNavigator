...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkRobotProbeNavTargetDescriptor);
vtkCxxRevisionMacro(vtkRobotProbeNavTargetDescriptor, "$Revision: 1.0 $");

//----------------------------------------------------------------------------
vtkRobotProbeNavTargetDescriptor::vtkRobotProbeNavTargetDescriptor()
{
...
//----------------------------------------------------------------------------
vtkRobotProbeNavTargetDescriptor::~vtkRobotProbeNavTargetDescriptor(void)
{
}

//----------------------------------------------------------------------------
void vtkRobotProbeNavTargetDescriptor::DeepCopy(vtkRobotProbeNavTargetDescriptor& src)
{
  this->Name=src.Name;
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavTargetDescriptor::PrintSelf(ostream& os, vtkIndent indent)
{
