...
//---------------------------------------------------------------------------
vtkCxxRevisionMacro(vtkMRMLRobotProbeNavNode, "$Revision: $");
vtkStandardNewMacro(vtkMRMLRobotProbeNavNode);


//---------------------------------------------------------------------------
vtkMRMLNode* vtkMRMLRobotProbeNavNode::CreateNodeInstance()
{
  
  vtkMRMLRobotProbeNavNode* node = vtkMRMLRobotProbeNavNode::New();
  
  // first try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkMRMLRobotProbeNavNode");
  if(ret)
    {
      return (vtkMRMLRobotProbeNavNode*)ret;
    }
  // if the factory was unable to create the object, then create it here
  return new vtkMRMLRobotProbeNavNode;
}


//---------------------------------------------------------------------------
vtkMRMLRobotProbeNavNode::vtkMRMLRobotProbeNavNode()
{
  ...
  this->GuidanceTipOffset[0] = this->GuidanceTipOffset[1] = this->GuidanceTipOffset[2] = std::numeric_liIGTs<float>::quiet_NaN();
  this->FRE = std::numeric_liIGTs<double>::quiet_NaN();
  this->ElapsedTime = std::numeric_liIGTs<double>::quiet_NaN();
...
//---------------------------------------------------------------------------
void vtkMRMLRobotProbeNavNode::PrintSelf(ostream& os, vtkIndent indent)
{
...
//---------------------------------------------------------------------------
void vtkMRMLRobotProbeNavNode::ReadXMLAttributes(const char** atts)
{
...
//---------------------------------------------------------------------------
void vtkMRMLRobotProbeNavNode::WriteXML(ostream& os, int nIndent)
{
...
//---------------------------------------------------------------------------
void vtkMRMLRobotProbeNavNode::Copy(vtkMRMLNode* anode)
{
  Superclass::Copy(anode);
  vtkMRMLRobotProbeNavNode* node = (vtkMRMLRobotProbeNavNode*)anode;
...
//---------------------------------------------------------------------------
void vtkMRMLRobotProbeNavNode::UpdateReferenceID(const char* oldID, const char* newID)
{
...
void vtkMRMLRobotProbeNavNode::test(void)
{
 // test
}
