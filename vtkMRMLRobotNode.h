...
class vtkRobotProbeNavTargetDescriptor;
struct NeedleDescriptorStruct;

class VTK_RobotProbeNAV_EXPORT vtkMRMLRobotNode : public vtkMRMLTransformableNode
{
...
// Description:
  ...
  virtual bool GetNeedleDirectionAtTarget(vtkRobotProbeNavTargetDescriptor *targetDesc, NeedleDescriptorStruct *needle, double* needleDirection) { return false; };

  virtual bool ShowRobotAtTarget(vtkRobotProbeNavTargetDescriptor *targetDesc, NeedleDescriptorStruct *needle) { return false; };
  //BTX
  virtual std::string GetTargetInfoText(vtkRobotProbeNavTargetDescriptor *targetDesc, NeedleDescriptorStruct *needle) { return ""; };
  ...
  // 1/22/2012 ayamada
  virtual const char* GetMarkersPositionTransformId() {return ""; };
  // 1/26/2012 ayamada
  virtual const char* GetMarkersPosition2TransformId() {return ""; };

  // 9/23/2011 ayamada
  virtual const char* GetCalibrationObjectModel2Id() {return ""; };
  virtual const char* GetCalibrationObjectModel3Id() {return ""; };
  virtual const char* GetCalibrationObjectModel4Id() {return ""; };
  virtual const char* GetCalibrationObjectModel5Id() {return ""; };
  virtual const char* GetCalibrationObjectModel6Id() {return ""; };
  
  // 9/24/2011 ayamada
  virtual const char* GetNeedleObjectModelId() {return ""; };
  virtual const char* GetNeedleObjectModel1Id() {return ""; };
  virtual const char* GetNeedleObjectModel2Id() {return ""; };
  
  // 10/19/2011 ayamada
  virtual const char* GetNeedlePathTransform1ID() {return ""; };
  virtual const char* GetNeedlePathTransform2ID() {return ""; };
  virtual const char* GetNeedlePathTransform3ID() {return ""; };

  // 10/26/2011 ayamada
  virtual const char* GetIGTRobotTransform1ID() {return ""; };
  virtual const char* GetIGTRobotTransform2ID() {return ""; };
  virtual const char* GetIGTRobotTransform3ID() {return ""; };
  virtual const char* GetIGTRobotTransform4ID() {return ""; };
  virtual const char* GetIGTRobotTransform5ID() {return ""; };
  // 7/21/2012 ayamada  
  virtual const char* GetIGTRobotTransform6ID() {return ""; };
  virtual const char* GetIGTRobotTransform7ID() {return ""; };
  
  // 2/10/2012 ayamada
  virtual const char* GetTargetPlaneTransformID() {return ""; };
  
  
  // 11/4/2011 ayamada
  virtual const char* GetVirtualCenterObjectModelId() {return ""; };
  virtual const char* GetVirtualCenterTransformId() {return ""; };
  
  // 6/30/2012 ayamada
  // this id is for zframe transform node (robot transform node)
