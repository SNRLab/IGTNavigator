...
==========================================================================*/
/// vtkMRMLRobotProbeNavNode - manages the data of the abdominal navigation module
///
/// This class stores references and data used by the abdominal navigation
/// module.

#ifndef __vtkMRMLRobotProbeNavNode_h
#define __vtkMRMLRobotProbeNavNode_h
...
class VTK_RobotProbeNAV_EXPORT vtkMRMLRobotProbeNavNode : public vtkMRMLNode
{
 public:
  //----------------------------------------------------------------
  // Usual VTK class functions.
  //----------------------------------------------------------------
  static vtkMRMLRobotProbeNavNode* New();
  vtkTypeRevisionMacro(vtkMRMLRobotProbeNavNode, vtkMRMLNode);
  ...
  //void test(vtkMRMLRobotProbeNavNode* node);
  void test(void);
 ...
 protected:
  ...
  // Usual VTK class functions.
  //----------------------------------------------------------------
  vtkMRMLRobotProbeNavNode();
  virtual ~vtkMRMLRobotProbeNavNode();
 ...
 private:
  ...
  // Usual VTK class functions.
  //----------------------------------------------------------------
  vtkMRMLRobotProbeNavNode(const vtkMRMLRobotProbeNavNode&); // not implemented
  void operator=(const vtkMRMLRobotProbeNavNode&);     // not implemented
  ...
  ///       position recorded.
  ///       Also, vtkMRMLRobotProbeNavNode::Copy(...) currently does
  ///       not take this class member into account.
  vtkCollection* RecordedPositions;

};

#endif // __vtkMRMLRobotProbeNavNode_h
