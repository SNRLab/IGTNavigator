...
int vtkMRMLRobotNode::Init(vtkSlicerApplication* app, const char* moduleShareDir)
{
  ...
  if (GetTargetTransformNode()==NULL)
  {
    ...
    tnode->SetName("RobotProbeNavRobotTarget");
  ...
  // 3/8/2012 ayamada
  //this->ModuleShareDirectory = this->GetGUI()->ModuleShareDirectory;
  //std::cerr << "path vtkMRMLNode = " << this->ModuleShareDirectory << std::endl;
