...
=========================================================================auto=*/
// .NAME vtkRobotProbeNavTargetDescriptor - describes the target, along with targeting paramteres and validation info
// .SECTION Description
// vtkRobotProbeNavTargetDescriptor describes the target, along with targeting paramteres and validation info

#ifndef _vtkRobotProbeNavTargetDescriptor_h
#define _vtkRobotProbeNavTargetDescriptor_h
#pragma once
...
struct VTK_RobotProbeNAV_EXPORT NeedleDescriptorStruct
{
...
class VTK_RobotProbeNAV_EXPORT vtkRobotProbeNavTargetDescriptor :
  public vtkObject
{
public:

  static vtkRobotProbeNavTargetDescriptor *New();
  vtkTypeRevisionMacro(vtkRobotProbeNavTargetDescriptor,vtkObject);
  void PrintSelf(ostream& os, vtkIndent indent);

  void DeepCopy(vtkRobotProbeNavTargetDescriptor& src);
...
private:
  ...
  vtkRobotProbeNavTargetDescriptor(void);
  ~vtkRobotProbeNavTargetDescriptor(void);

  vtkRobotProbeNavTargetDescriptor(const vtkRobotProbeNavTargetDescriptor&);
  void operator=(const vtkRobotProbeNavTargetDescriptor&);
};
