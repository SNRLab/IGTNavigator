...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkRobotProbeNavStepTargetingTemplate);
vtkCxxRevisionMacro(vtkRobotProbeNavStepTargetingTemplate, "$Revision: 1.1 $");

//----------------------------------------------------------------------------
vtkRobotProbeNavStepTargetingTemplate::vtkRobotProbeNavStepTargetingTemplate()
{
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavStepTargetingTemplate::ShowUserInterface()
{
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavStepTargetingTemplate::ShowTargetPlanningFrame()
{
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavStepTargetingTemplate::ShowTargetListFrame()
{
  vtkKWWidget *parent = this->GetGUI()->GetWizardWidget()->GetClientArea();
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavStepTargetingTemplate::ShowTargetControlFrame()
{
  vtkKWWidget *parent = this->GetGUI()->GetWizardWidget()->GetClientArea();
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavStepTargetingTemplate::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavStepTargetingTemplate::ProcessGUIEvents(vtkObject *caller,
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavStepTargetingTemplate::ProcessMRMLEvents(vtkObject *caller,
                                         unsigned long event, void *callData)
{
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavStepTargetingTemplate::AddMRMLObservers()
{
  vtkMRMLRobotProbeNavManagerNode* manager=this->GetRobotProbeNavManager();
  if (manager==NULL)
  {
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavStepTargetingTemplate::RemoveMRMLObservers()
{
...
//---------------------------------------------------------------------------
void vtkRobotProbeNavStepTargetingTemplate::OnMultiColumnListUpdate(int row, int col, char * str)
{
...
//---------------------------------------------------------------------------
void vtkRobotProbeNavStepTargetingTemplate::OnMultiColumnListSelectionChanged()
{
  ...
  if (numRows == 1)
    ...
    if ( this->Logic )
      ...
      vtkMRMLNode* node = this->GetLogic()->GetApplicationLogic()->GetMRMLScene()
        ->GetNodeByID(this->GetRobotProbeNavManager()->GetRobotNode()->GetTargetTransformNodeID());
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavStepTargetingTemplate::UpdateTargetListGUI()
{
...
//-----------------------------------------------------------------------------
void vtkRobotProbeNavStepTargetingTemplate::AddGUIObservers()
{
...
//-----------------------------------------------------------------------------
void vtkRobotProbeNavStepTargetingTemplate::RemoveGUIObservers()
{
  //if (this->LoadTargetingVolumeButton)
  //  {
...
//--------------------------------------------------------------------------------
void vtkRobotProbeNavStepTargetingTemplate::UpdateGUI()
{
  vtkMRMLRobotProbeNavManagerNode *mrmlNode = this->GetGUI()->GetRobotProbeNavManagerNode();
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavStepTargetingTemplate::HideUserInterface()
{  
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavStepTargetingTemplate::EnableAddTargetsOnClickButton(bool enable)
{
  if (this->GetRobotProbeNavManager()==NULL)
  {
    return;
