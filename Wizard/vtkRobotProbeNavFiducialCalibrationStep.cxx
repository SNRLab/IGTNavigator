...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkRobotProbeNavFiducialCalibrationStep);
vtkCxxRevisionMacro(vtkRobotProbeNavFiducialCalibrationStep, "$Revision: 1.1 $");

//----------------------------------------------------------------------------
vtkRobotProbeNavFiducialCalibrationStep::vtkRobotProbeNavFiducialCalibrationStep()
{
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os,indent);
}

//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::ShowLoadResetControls()
{
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::ShowLoadVolumeControls()
{
  vtkKWWidget *parent = this->GetGUI()->GetWizardWidget()->GetClientArea();
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::ShowFiducialSegmentParamsControls()
{
  vtkKWWidget *parent = this->GetGUI()->GetWizardWidget()->GetClientArea();
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::ShowFiducialSegmentationResultsControls()
{
  vtkKWWidget *parent = this->GetGUI()->GetWizardWidget()->GetClientArea();
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::ShowExportImportControls()
{
   vtkKWWidget *parent = this->GetGUI()->GetWizardWidget()->GetClientArea();
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::ShowUserInterface()
{
  ...
  vtkMRMLTransRectalRobotProbeRobotNode* robot=GetRobot();
  if(robot!=NULL)
  {    
...
//-------------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::HideUserInterface()
{
...
//----------------------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::TearDownGUI()
{
  RemoveMRMLObservers();
  RemoveGUIObservers();   
}
...
//----------------------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::PopulateCalibrationResults()
{
  std::ostrstream os;  
  
  vtkMRMLTransRectalRobotProbeRobotNode* robot=GetRobot();
  TRRobotProbeBiopsyCalibrationData calibData;
  if (robot!=NULL)
  {    
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::AddGUIObservers()
{
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::RemoveGUIObservers()
{
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::Enter()
{  

}

//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::Exit()
{

}

//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::WizardGUICallback( vtkObject *caller,
                         unsigned long eid, void *clientData, void *callData )
{

  vtkRobotProbeNavFiducialCalibrationStep *self = reinterpret_cast<vtkRobotProbeNavFiducialCalibrationStep *>(clientData);
  ...
  vtkDebugWithObjectMacro(self, "In vtkTRRobotProbeCalibrationBiopsyStep GUICallback");
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::UpdateMRML() 
{
  vtkMRMLTransRectalRobotProbeRobotNode* robot=GetRobot();
  if(robot==NULL)
  {
  ...
  vtkMRMLRobotProbeNavManagerNode *managerNode = this->GetGUI()->GetRobotProbeNavManagerNode();
  if(managerNode==NULL)
  {
    return;
  }
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::UpdateGUI() 
{
  vtkMRMLTransRectalRobotProbeRobotNode* robot= GetRobot();
  if(robot==NULL)
  {
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::ProcessGUIEvents(vtkObject *caller,
        unsigned long event, void *callData)
{
  //slicerCerr("vtkRobotProbeNavFiducialCalibrationStep::ProcessGUIEvents");
...
//-----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::Reset()
{
  vtkMRMLTransRectalRobotProbeRobotNode* robot=GetRobot();
  if (robot==NULL)
  {
...
//-----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::Resegment()
{
...
//--------------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::ShowAxesIn3DView(bool show)
{
  vtkMRMLTransRectalRobotProbeRobotNode* robot = GetRobot();    
  if (robot)
  {
...
vtkMRMLTransRectalRobotProbeRobotNode* vtkRobotProbeNavFiducialCalibrationStep::GetRobot()
{
  if (this->GetGUI()==NULL)
  {
    return NULL;
  }
  if (this->GetGUI()->GetRobotProbeNavManagerNode()==NULL)
  {
    return NULL;
  }
  return vtkMRMLTransRectalRobotProbeRobotNode::SafeDownCast(this->GetGUI()->GetRobotProbeNavManagerNode()->GetRobotNode());
}

//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::ProcessMRMLEvents(vtkObject *caller,
                                         unsigned long event, void *callData)
{
  ...
  // Robot node changed
  vtkMRMLTransRectalRobotProbeRobotNode *robot = vtkMRMLTransRectalRobotProbeRobotNode::SafeDownCast(caller);
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::AddMRMLObservers()
{
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::RemoveMRMLObservers()
{
...
//----------------------------------------------------------------------------
void vtkRobotProbeNavFiducialCalibrationStep::EnableMarkerPositionEdit(bool enable)
{  
...
void vtkRobotProbeNavFiducialCalibrationStep::JumpToFiducial(unsigned int fid1Index)
{
...
vtkMRMLFiducialListNode* vtkRobotProbeNavFiducialCalibrationStep::GetCalibrationPointListNode()
{
  vtkMRMLTransRectalRobotProbeRobotNode* robot=GetRobot();
  if(robot==NULL)
  {  
