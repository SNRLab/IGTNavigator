...
=========================================================================auto=*/
#ifndef __vtkMRMLRobotProbeNavManagerNode2_h
#define __vtkMRMLRobotProbeNavManagerNode2_h
...
*/
class VTK_RobotProbeNAV_EXPORT vtkMRMLRobotProbeNavManagerNode2 : public vtkMRMLNode
{
 ...
 public:
  ...
  static const char* GetRobotProbeNavModuleVersion();
  static int GetRobotProbeNavWorkingCopyRevision();

  //----------------------------------------------------------------
  // Standard methods for MRML nodes
  //----------------------------------------------------------------

  static vtkMRMLRobotProbeNavManagerNode2 *New();
  vtkTypeMacro(vtkMRMLRobotProbeNavManagerNode2,vtkMRMLNode);
...
// Description:
  ...
  NeedleDescriptorStruct* GetNeedle(vtkRobotProbeNavTargetDescriptor *targetDesc);
  ...
  unsigned int AddTargetDescriptor(vtkRobotProbeNavTargetDescriptor *target);
  int RemoveTargetDescriptorAtIndex(unsigned int index); // return with 0 if failed
  vtkRobotProbeNavTargetDescriptor *GetTargetDescriptorAtIndex(unsigned int index);
 ...
 protected:
  ...
  vtkMRMLRobotProbeNavManagerNode2();
  ~vtkMRMLRobotProbeNavManagerNode2();
  vtkMRMLRobotProbeNavManagerNode2(const vtkMRMLRobotProbeNavManagerNode2&);
  void operator=(const vtkMRMLRobotProbeNavManagerNode2&);
 ...
 protected:
  ...
  std::vector<vtkRobotProbeNavTargetDescriptor*> TargetDescriptorsVector;
