...
=========================================================================auto=*/
#ifndef __vtkMRMLRobotProbeNavManagerNode_h
#define __vtkMRMLRobotProbeNavManagerNode_h
...
class VTK_RobotProbeNAV_EXPORT vtkMRMLRobotProbeNavManagerNode : public vtkMRMLNode
{
 ...
 public:
  ...
  static vtkMRMLRobotProbeNavManagerNode *New();
  vtkTypeMacro(vtkMRMLRobotProbeNavManagerNode,vtkMRMLNode);
...
// Description:
 ...
 protected:
  ...
  vtkMRMLRobotProbeNavManagerNode();
  ~vtkMRMLRobotProbeNavManagerNode();
  vtkMRMLRobotProbeNavManagerNode(const vtkMRMLRobotProbeNavManagerNode&);
  void operator=(const vtkMRMLRobotProbeNavManagerNode&);
