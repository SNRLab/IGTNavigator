...
//------------------------------------------------------------------------------
vtkMRMLRobotProbeNavManagerNode* vtkMRMLRobotProbeNavManagerNode::New()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkMRMLRobotProbeNavManagerNode"); if(ret)
    {
      return (vtkMRMLRobotProbeNavManagerNode*)ret;
    }
  // If the factory was unable to create the object, then create it here.
  return new vtkMRMLRobotProbeNavManagerNode;
}

//----------------------------------------------------------------------------
vtkMRMLNode* vtkMRMLRobotProbeNavManagerNode::CreateNodeInstance()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkMRMLRobotProbeNavManagerNode");
  if(ret)
    {
      return (vtkMRMLRobotProbeNavManagerNode*)ret;
    }
...
//----------------------------------------------------------------------------
vtkMRMLRobotProbeNavManagerNode::vtkMRMLRobotProbeNavManagerNode()
{
...
//----------------------------------------------------------------------------
void vtkMRMLRobotProbeNavManagerNode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void vtkMRMLRobotProbeNavManagerNode::ReadXMLAttributes(const char** atts)
{
...
bool vtkMRMLRobotProbeNavManagerNode::GetAttNameSection(const std::string& attName, const std::string& groupName, unsigned int &sectionInd, std::string &sectionName)
{
...
void vtkMRMLRobotProbeNavManagerNode::Copy(vtkMRMLNode *anode)
{
  Superclass::Copy(anode);
  vtkMRMLRobotProbeNavManagerNode *node = (vtkMRMLRobotProbeNavManagerNode *) anode;
...
//-----------------------------------------------------------
void vtkMRMLRobotProbeNavManagerNode::UpdateReferences()
{
...
//----------------------------------------------------------------------------
void vtkMRMLRobotProbeNavManagerNode::UpdateReferenceID(const char *oldID, const char *newID)
{
...
//-----------------------------------------------------------
void vtkMRMLRobotProbeNavManagerNode::UpdateScene(vtkMRMLScene *scene)
{
...
//----------------------------------------------------------------------------
void vtkMRMLRobotProbeNavManagerNode::ProcessMRMLEvents( vtkObject *caller, unsigned long event, void *callData )
{
...
//----------------------------------------------------------------------------
void vtkMRMLRobotProbeNavManagerNode::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
int vtkMRMLRobotProbeNavManagerNode::GetNumberOfSteps()
{
...
//----------------------------------------------------------------------------
const char* vtkMRMLRobotProbeNavManagerNode::GetStepName(int i)
{
...
//----------------------------------------------------------------------------
int vtkMRMLRobotProbeNavManagerNode::SwitchStep(int newStep)
{
...
//----------------------------------------------------------------------------
int vtkMRMLRobotProbeNavManagerNode::GetCurrentStep()
{
  return this->CurrentStep;
}

//----------------------------------------------------------------------------
vtkStdString vtkMRMLRobotProbeNavManagerNode::GetWorkflowStepsString()
{
...
//----------------------------------------------------------------------------
bool vtkMRMLRobotProbeNavManagerNode::SetWorkflowStepsFromString(const vtkStdString& workflowStepsString)
{ 
  if (this->StepList==NULL)
  {
...
//----------------------------------------------------------------------------
void vtkMRMLRobotProbeNavManagerNode::SetAndObserveTargetPlanListNodeID(const char *nodeID)
{
...
//----------------------------------------------------------------------------
vtkMRMLFiducialListNode* vtkMRMLRobotProbeNavManagerNode::GetTargetPlanListNode()
{
...
//----------------------------------------------------------------------------
void vtkMRMLRobotProbeNavManagerNode::SetAndObserveRobotNodeID(const char *nodeID)
{
...
//----------------------------------------------------------------------------
vtkMRMLRobotNode* vtkMRMLRobotProbeNavManagerNode::GetRobotNode()
{
...
//-------------------------------------------------------------------------------
unsigned int vtkMRMLRobotProbeNavManagerNode::AddTargetDescriptor(vtkRobotProbeNavTargetDescriptor* target)
{
...
//-------------------------------------------------------------------------------
vtkRobotProbeNavTargetDescriptor* vtkMRMLRobotProbeNavManagerNode::GetTargetDescriptorAtIndex(unsigned int index)
{
...
//-------------------------------------------------------------------------------
int vtkMRMLRobotProbeNavManagerNode::RemoveTargetDescriptorAtIndex(unsigned int index)
{
  if (index >= this->TargetDescriptorsVector.size())
    {
    return 0;
...
//-------------------------------------------------------------------------------
int vtkMRMLRobotProbeNavManagerNode::SetCurrentTargetIndex(int index)
{
  ...
  this->Modified();
  this->InvokeEvent(vtkMRMLRobotProbeNavManagerNode::CurrentTargetChangedEvent);
  return this->CurrentTargetIndex;
}

//-------------------------------------------------------------------------------
bool vtkMRMLRobotProbeNavManagerNode::AddTargetToFiducialList(double targetRAS[3], unsigned int fiducialListIndex, unsigned int targetNr, int & fiducialIndex)
{
...
//-------------------------------------------------------------------------------
bool vtkMRMLRobotProbeNavManagerNode::GetTargetFromFiducialList(int fiducialListIndex, int fiducialIndex, double &r, double &a, double &s)
{
...
//-------------------------------------------------------------------------------
void vtkMRMLRobotProbeNavManagerNode::SetFiducialColor(int fiducialIndex, bool selected)
{
  vtkMRMLFiducialListNode* fidNode=this->GetTargetPlanListNode();
  if (fidNode==NULL)
  {
...
//------------------------------------------------------------------------------
void vtkMRMLRobotProbeNavManagerNode::Init(const char* defaultNeedleListConfig)
{
  if (this->Initialized)
  {
    return;
...
bool vtkMRMLRobotProbeNavManagerNode::ReadNeedleListFromConfigXml(const char* needleListConfigStr)
{  
...
bool vtkMRMLRobotProbeNavManagerNode::SetNeedle(unsigned int needleIndex, NeedleDescriptorStruct needleDesc)
{
...
bool vtkMRMLRobotProbeNavManagerNode::GetNeedle(unsigned int needleIndex, NeedleDescriptorStruct &needleDesc)
{
  if (needleIndex >= this->NeedlesVector.size())
    {
    return false;
...
NeedleDescriptorStruct* vtkMRMLRobotProbeNavManagerNode::GetNeedle(vtkRobotProbeNavTargetDescriptor *targetDesc)
{
  if (targetDesc==NULL)
  {
    return NULL;
...
const char* vtkMRMLRobotProbeNavManagerNode::GetRobotProbeNavModuleVersion()
{
  return RobotProbe_NAV_MODULE_VERSION;
}

int vtkMRMLRobotProbeNavManagerNode::GetRobotProbeNavWorkingCopyRevision()
{
